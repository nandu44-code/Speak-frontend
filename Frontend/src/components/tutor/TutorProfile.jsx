  ...
  return (
    <div className='flex flex-row'>
        ...
        <div className='flex flex-col w-full mt-10 items-center mb-5'>
            ...
            <div className='flex flex-row bg-gray-300 gap-4 justify-center w-1/2 rounded-sm mb-1'>
            ...
            <div className='flex flex-row bg-gray-200 gap-4 justify-center w-1/2 rounded-sm mb-1'>
