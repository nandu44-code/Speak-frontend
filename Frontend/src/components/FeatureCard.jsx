...
const CustomCard = ({ icon, heading, paragraph }) => {
  return (
    <div className="w-full bg-slate-300 rounded-xl p-5 m-2 hover:scale-110 hover:border-b-4 border-indigo-600 hover:border-x-2 duration-700 hover:rounded-3xl cursor-pointer 
