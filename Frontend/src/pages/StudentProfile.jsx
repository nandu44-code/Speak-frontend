...
import { getMyProfile, changeUserName, changeProfileImage } from "../features/userSlice";
          ...
          >
            <input
              ...
              onChange={(e) => {
                ...
                uploadImage(); // Trigger uploadImage function when a file is selected
              }}
            />

            <label htmlFor="fileInput" >
              <img
                src={userprofile && userprofile.profile_image ? userprofile.profile_image : imageSrc}
                alt="no image"
